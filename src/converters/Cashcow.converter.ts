...
import {ECashcowOrderStatus, ICashcowAddOrUpdateObject, ICashcowUpdateOrderRequest, IOrder} from '../types';
...
export class CashcowConverter {
    ...
    static convertProductToCashcowFormat(
        ...
        const temp: ICashcowAddOrUpdateObject = {
            ...
            qty: product.qty,
            is_visible: product.isActive && product.isApprovedForWeb && product.sellPrice > 0 && product.qty > 0
        };
